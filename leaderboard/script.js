...
const url =
  'https://api2.hackclub.com/v0.1/Summer%20of%20Making%20Streaks/Slack%20Accounts?select={"maxRecords": 32,"fields":["Username","Max Streaks"],"sort":[{"field": "Max Streaks", "direction": "desc"}]}';
fetch(url)
  .then(resp => resp.json())
  .then(function(data) {
    var x = 0;
